...
(display "This file contains sample code from March 20, 2026,\n")
...
(define (my-map f xs)
  (cond
    ...
    [else        (error "my-map: arg #2 is not a list")]
    )
  )

; Try:
;   (sqr 5)
;   (my-map sqr '(2 33 -5 50 1 100))
...
;   (my-map (lambda (x) (* x x x)) '(2 33 -5 50 1 100))
