...
-- Code from Jan 28 - Example Lua Module
...
-- in some Lua program.
-- Then you can, for example, call function "mymodule.print_with_stars".
...
-- print_with_border
-- Given message and border character, prints message using the
-- character as the border.
-- NOT EXPORTED
...
-- print_with_stars
-- Given message, prints message surrounded by stars.
-- EXPORTED
