...
-- metatable is mt. Let's give mt the equivalent of a constructor: a
-- member "new" that creates an object and returns it.
function mt.new()
    local t = {}
...
-- Now use the closure returned above.
times2 = multiply(2)      -- Function that multiplies by 2
triple = multiply(3)      -- Function that multiplies by 3
times100 = multiply(100)  -- Function that multiples by 100
...
io.write("\n")
io.write("This file contains sample code from January 30, 2026,\n")
